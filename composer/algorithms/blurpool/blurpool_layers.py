...
class BlurConv2d(nn.Module):
    ...
    def __init__(
        ...
        # Precompute the filter and register it as a buffer
        filt = _default_2d_filter()
        self.register_buffer(
            "blur_filter", filt.expand(self.blur_nchannels, 1, *filt.shape[2:])
        )
