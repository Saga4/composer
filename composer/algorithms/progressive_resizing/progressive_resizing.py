...
def _make_crop(tensor: torch.Tensor, scale_factor: float) -> T_ResizeTransform:
    ...
    # Use random.randint from Python's standard library for scalar integer generation
    top = torch.randint(0, tensor.shape[2] - Hc, (1,)).item()
    left = torch.randint(0, tensor.shape[3] - Wc, (1,)).item()
