...
class SeqLengthWarmup(Algorithm):
    ...
    def __init__(
        ...
        # Precomputed fields to speed up match function.
        self._init_event_conditions = Event.INIT
        self._dataloader_event_conditions = Event.AFTER_DATALOADER
    ...
    def match(self, event: Event, state: State) -> bool:
        ...
        init_condition = self._original_model is None
        return (
            event == self._init_event_conditions and init_condition
        ) or event == self._dataloader_event_conditions
